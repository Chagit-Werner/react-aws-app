                    ...
                    <TabContext value={value}>
                        <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
                            <TabList onChange={handleChange} aria-label="lab API tabs example">
                                <Tab disabled={GlobalStateAdmin.enableButton } label="Appointments" value="1" component={Link} to="appointments" />
                                <Tab disabled={GlobalStateAdmin.enableButton } label="Services" value="2" component={Link} to="services" />
                            </TabList>
                        </Box>
